...
//             ? null
//             : SearchPassMeta.fromJson(json["searchPassMeta"]),
//         queryId: json["queryId"],
//         discoverSearchProductTypes: json["discoverSearchProductTypes"] == null
//             ? []
//             : List<dynamic>.from(
//                 json["discoverSearchProductTypes"]!.map((x) => x)),
//         campaigns: json["campaigns"] == null
//             ? null
//             : Campaigns.fromJson(json["campaigns"]),
//       );
//
//   Map<String, dynamic> toJson() => {
...
//         "facets": facets == null
//             ? []
//             : List<dynamic>.from(facets!.map((x) => x.toJson())),
//         "diagnostics": diagnostics?.toJson(),
//         "searchPassMeta": searchPassMeta?.toJson(),
//         "queryId": queryId,
//         "discoverSearchProductTypes": discoverSearchProductTypes == null
//             ? []
...
//         imageTiles: json["imageTiles"] == null
//             ? []
//             : List<dynamic>.from(json["imageTiles"]!.map((x) => x)),
//         promoBanners: json["promoBanners"] == null
//             ? []
//             : List<dynamic>.from(json["promoBanners"]!.map((x) => x)),
//         sponsoredProducts: json["sponsoredProducts"] == null
//             ? []
//             : List<dynamic>.from(json["sponsoredProducts"]!.map((x) => x)),
//       );
//
//   Map<String, dynamic> toJson() => {
//         "imageTiles": imageTiles == null
//             ? []
//             : List<dynamic>.from(imageTiles!.map((x) => x)),
//         "promoBanners": promoBanners == null
//             ? []
//             : List<dynamic>.from(promoBanners!.map((x) => x)),
//         "sponsoredProducts": sponsoredProducts == null
//             ? []
...
//         itemsFromPartner: json["itemsFromPartner"] == null
//             ? []
//             : List<dynamic>.from(json["itemsFromPartner"]!.map((x) => x)),
//         placementBeacons: json["placementBeacons"] == null
//             ? null
//             : PlacementBeacons.fromJson(json["placementBeacons"]),
//       );
//
//   Map<String, dynamic> toJson() => {
//         "status": status,
...
//         "itemsFromPartner": itemsFromPartner == null
//             ? []
//             : List<dynamic>.from(itemsFromPartner!.map((x) => x)),
...
//         id: json["id"],
//         name: json["name"],
//         facetValues: json["facetValues"] == null
//             ? []
//             : List<FacetValue>.from(
...
//         "id": id,
//         "name": name,
//         "facetValues": facetValues == null
//             ? []
//             : List<dynamic>.from(facetValues!.map((x) => x.toJson())),
...
//         facetGroupings: json["facetGroupings"] == null
//             ? []
//             : List<FacetGrouping>.from(
//                 json["facetGroupings"]!.map((x) => FacetGrouping.fromJson(x))),
...
//         "facetGroupings": facetGroupings == null
//             ? []
//             : List<dynamic>.from(facetGroupings!.map((x) => x.toJson())),
...
//         products: json["products"] == null
//             ? []
//             : List<FacetGroupingProduct>.from(
//                 json["products"]!.map((x) => FacetGroupingProduct.fromJson(x))),
//         type: json["type"],
//       );
//
//   Map<String, dynamic> toJson() => {
...
//   });
//
//   factory FacetGroupingProduct.fromJson(Map<String, dynamic> json) =>
//       FacetGroupingProduct(
...
//         searchPass: json["searchPass"] == null
//             ? []
//             : List<dynamic>.from(json["searchPass"]!.map((x) => x)),
//         alternateSearchTerms: json["alternateSearchTerms"] == null
//             ? []
...
//             ? []
//             : List<dynamic>.from(searchPass!.map((x) => x)),
//         "alternateSearchTerms": alternateSearchTerms == null
//             ? []
